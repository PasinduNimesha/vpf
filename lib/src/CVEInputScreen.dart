...
class CVEInputScreen extends StatefulWidget {
  const CVEInputScreen({super.key});

  @override
  _CVEInputScreenState createState() => _CVEInputScreenState();
}

class _CVEInputScreenState extends State<CVEInputScreen> {
  ...
  Future<void> _fetchVulnerabilityData() async {
    ...
    try {
      ...
      print('Fetching EPSS data for $cveCode...');
