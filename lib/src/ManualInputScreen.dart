...
class _ManualInputScreenState extends State<ManualInputScreen> {
  final TextEditingController _cvssController = TextEditingController();
  final TextEditingController _epssController = TextEditingController();
  ...
  void _calculatePriorityScore() {
    final cvssScore = double.tryParse(_cvssController.text.trim());
    final epssScore = double.tryParse(_epssController.text.trim());

    if (cvssScore == null || epssScore == null || _selectedAssetType == null) {
      setState(() => _severity = 'Please enter valid scores and select an asset type.');
      return;
    }
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.speed, color: Colors.indigo),
                hintText: 'e.g., 7.5',
              ),
            ...
            TextField(
              controller: _epssController,
              decoration: InputDecoration(
                labelText: 'EPSS Score',
            ...
            ElevatedButton.icon(
              ...
              onPressed: _calculatePriorityScore,
            ),
            if (_severity != null) ...[
